...
\begin{document}
% !TEX root = velocita_luce/latex/relazione.tex
...
{\uppercase{\Large Lab Report:\\ misura della velocità della luce\par}}
\vspace{3cm}
...
\section{Abstract}
L'obbiettivo dell'esperimento è la misura della velocità della luce in aria. Riproducendo l'esperimento di Focault, è stato ricavato indirettamente il seguente risultato: \[c = (2.94 \pm 0.22)\cdot10^8 \qq {m/s}\]

compatibile entro 0.3 $\sigma$ dal valore noto.

\section{Metodi}
La misura ha avuto luogo attraverso due fasi principali: la calibrazione dell'apparato e l'effettiva misurazione delle grandezze fisiche utili al calcolo della velocità della luce.
    ...
    \begin{table}
        ...
        \begin{minipage}{0.4\linewidth}
            ...
            \begin{tabular}{ l  c  c  } 
                ...
                \bottomrule                
            \end{tabular}
            \captionof{table}{Distanze specchi}
        \end{minipage}
    \end{table}
