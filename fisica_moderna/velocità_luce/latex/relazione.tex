...
\begin{document}
    ...
    \section{Abstract}
        ...
        L'obbiettivo dell'esperimento è la misura della velocità di propagazione della luce in aria. \\
        Per poter effettuare questa misura sono state sfruttate le proprietà di riflessione e la finitezza della velocità di 
        propagazione della luce, misurata quantitativamente per la prima volta nel '600 dall'astronomo danese Rømer.
        Riproducendo l'esperimento di Focault, consistente nell'utilizzo di uno specchio rotante con nota velocità angolare e 
        nella misura della differenza di posizione della luce riflessa per due diverse velocità di rotazione dello specchio, 
        è stato possibile calcolare indirettamente la velocità della luce. \\
        
        È riportato di seguito il risultato finale: \[ c = (2,94 \pm 0,22) \cdot 10^8 \, \mathrm{m/s} \] 
        compatibile entro 0,3 $\sigma$ dal valore noto.
    ...
    \section{Metodi}
        ...
        \subsection{Misure distanze specchi}
            ...
            \begin{table}[H]
                ...
                \captionof{table}{Misure delle distanze tra gli specchi}
        ...
        \subsection{Misure con rotazione dello specchio in senso orario}
            ...
            \begin{table}[H]
                ...
                \captionof{table}{Dati grezzi con relative incertezze delle misure con specchio in rotazione oraria}
        ...
        \subsection{Misure con rotazione dello specchio in senso antiorario}
            ...
            \begin{table}[H]
                ...
                \begin{minipage}{0.65\linewidth}
                    ...
                    \captionof{figure}{Distribuzione delle velocità con lo specchio in rotazione antioraria}
                    \label{fig:c_CCW}
        ...
        \subsection{Misure con rotazione alternata dello specchio}
            ...
            \begin{table}[H]
                ...
                \begin{minipage}{0.6\linewidth}
                    ...
                    \captionof{figure}{Distribuzione delle velocità}
