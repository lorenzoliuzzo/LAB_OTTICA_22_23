...
\begin{document}
    ...
    \begin{center}
        ...
        \uppercase{\Large Relazione di laboratorio:\\ spettrometro a reticolo\par}
        \vspace{3cm}
    ...
    \label{Appendice}
        ...
        % Passo del reticolo e numero di fenditure
        \begin{table}[H]
